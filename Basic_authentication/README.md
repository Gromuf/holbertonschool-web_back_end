...
Now the biggest piece is the filtering of each request. For that you will use the Flask method [before_request](/rltoken/UZQCfuQf9PG4mBHY9iKBog "before_request")
